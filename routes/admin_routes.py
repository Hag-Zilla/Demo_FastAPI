...
@router.put("/users/{user_id}/", responses=responses, name="Update User", tags=["Administrative"])
...
@router.delete("/users/{user_id}/", responses=responses, name="Delete User", tags=["Administrative"])
...
@router.get("/reports/", responses=responses, name="All Users Reports", tags=["Administrative"])
